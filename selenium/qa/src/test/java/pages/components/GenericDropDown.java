...
public class GenericDropDown extends BaseComponent {
	...
	public boolean isOptionSelected(String value) {
		explicitWaitForVisiblity(activateDropDown);
		String text = activateDropDown.getText();
		if (text != null && text.equals(value)){
			return true;
		}
		String attrValue = activateDropDown.getAttribute("value");
		if (attrValue != null && text.equals(value)) {
			return true;
		}
		return false;
	}
