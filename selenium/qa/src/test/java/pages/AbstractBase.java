...
public class AbstractBase {
	...
	public void waitVisibilityAndClick(WebElement element) {
		explicitWait(15, ExpectedConditions.and(ExpectedConditions.visibilityOf(element), ExpectedConditions.elementToBeClickable(element)));
		element.click();
	}
	...
	public void waitForTime(long mills) {
		try {
			Wait<WebDriver> wait = new FluentWait<WebDriver>(driver)
					...
					.pollingEvery(mills, TimeUnit.MICROSECONDS)
	...
	/**
	 * NOTE: SAFARI DOES NOT SUPPORT ACTIONS API
	 * @param text
	 * @return
	 */
